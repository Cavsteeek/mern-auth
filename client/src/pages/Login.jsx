    ...
    <div className='flex items-center justify-center min-h-screen px-6 sm:px-0 bg-gradient-to-br from-blue-200 to-purple-400'>
      ...
      <div className='bg-slate-900 p-10 rounded-xl shadow-lg w-full sm:w-96 text-indigo-300 text-sm'>
        ...
        <form onSubmit={onSubmitHandler}>
          ...
          <button className='w-full bg-gradient-to-r from-indigo-500 to-purple-900 py-2.5 rounded-full text-white font-semibold hover:from-indigo-600 hover:to-purple-600 transition-all mb-4'>{state}</button>
        </form>
